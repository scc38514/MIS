...
<form action="peisong" method="get">
	<table id="tt"  style="width:1200px;height:250px"
		...
		<thead>
			...
			<tr>
				...
				<td  width="80">
				<input class="easyui-textbox" name="ps1" style="width:100%;height:35px">
				</td>
				<td  width="80" align="right">
				<input class="easyui-textbox" name="ps2" style="width:100%;height:35px">
				</td>
				<td  width="80" align="right">
				<input class="easyui-textbox" name="ps3" style="width:100%;height:35px">
				</td>
