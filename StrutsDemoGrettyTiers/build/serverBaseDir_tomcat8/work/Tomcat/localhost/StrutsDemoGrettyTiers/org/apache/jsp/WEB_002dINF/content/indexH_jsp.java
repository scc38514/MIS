 ...
 * Generated at: 2016-12-19 08:29:28 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t{\"menuid\":\"39\",\"icon\":\"icon-sys\",\"menuname\":\"当日详情\",\r\n");
      out.write("\t\t\t\t\t\t\t\"menus\":[{\"menuname\":\"采购详情\",\"icon\":\"icon-nav\",\"url\":\"cgxq\"},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t{\"menuname\":\"库存详情\",\"icon\":\"icon-add\",\"url\":\"kkxq\"},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t{\"menuname\":\"供货详情\",\"icon\":\"icon-add\",\"url\":\"psxq\"}\r\n");
      out.write("\t\t\t\t\t\t\t\t]\r\n");
      out.write("\t\t\t\t\t\t},{\"menuid\":\"8\",\"icon\":\"icon-sys\",\"menuname\":\"查看报表\",\r\n");
      out.write("\t\t\t\t\t\t\t\"menus\":[{\"menuname\":\"成本账单\",\"icon\":\"icon-nav\",\"url\":\"cgxq\"},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t{\"menuname\":\"采购量表\",\"icon\":\"icon-add\",\"url\":\"cglb\"},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t{\"menuname\":\"余量表\",\"icon\":\"icon-add\",\"url\":\"ylb\"}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t]\r\n");
      out.write("\t\t\t\t\t\t\t},{\"menuid\":\"56\",\"icon\":\"icon-sys\",\"menuname\":\"辅助功能\",\r\n");
      out.write("\t\t\t\t\t\t\t\t\"menus\":[{\"menuname\":\"留言\",\"icon\":\"icon-nav\",\"url\":\"liuyan\"},\r\n");
      out.write("\t\t\t\t\t\t\t\t         {\"menuname\":\"留言处理\",\"icon\":\"icon-add\",\"url\":\"liuyanshow\"},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t{\"menuname\":\"查询\",\"icon\":\"icon-add\",\"url\":\"search\"},\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t{\"menuname\":\"备份恢复\",\"icon\":\"icon-add\",\"url\":\"\"}\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t]\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t]};\r\n");
      out.write("      \r\n");
